...
from utils.datautils import load_from_tsfile
import warnings
...
class Dataset_Classification:
    def __init__(self, root_path, flag='train', size=None,
        ...
        self.seq_len = size[0]
        self.train_file_path_and_name = os.path.join(root_path, data_path, data_path+"_TRAIN.ts")
        self.test_file_path_and_name = os.path.join(root_path, data_path, data_path+"_TEST.ts")
    ...
    def __getitem__(self, index):
        ...
        return np.expand_dims(timeseries, axis=1), labels