...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred_n_heads', type=int, default=8, help='num of heads')
    parser.add_argument('--pred_num_hidden_layers', type=int, default=3, help='num of predictor layers')
